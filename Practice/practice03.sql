...
select  de.department_id "부서번호",
        ...
        lo.city "위치한도시",
        co.country_name "나라이름",
        re.region_name "지역구분이름"
from employees man, departments de, locations lo, countries co, regions re
...
select  em.employee_id "사번",
        ...
        de.department_name "부서명",
        man.first_name "매니저이름"
from employees em left outer join departments de on em.department_id = de.department_id, employees man
where em.manager_id = man.employee_id;
